...
export default async function AboutPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-12 sm:px-6 sm:py-16">
      ...
      <h1 className="font-display text-xl font-bold text-orokin sm:text-2xl">About the data</h1>
      ...
      <Section title="Your data">
        <p>
          ...
          <Link href="/collection" className="text-text underline underline-offset-4 hover:text-orokin">
            export a backup
          </Link>{' '}
      ...
      <Section title="Corrections">
        <p>
          ...
          <a
            ...
            className="text-text underline underline-offset-4 hover:text-orokin"
          >
            source
          </a>
          .
